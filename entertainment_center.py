...
# See http://docs.themoviedb.apiary.io/#reference/configuration/configuration/get for information on what's going on here.
...
for movie in movies_titles:
    ...
    for s in response['results']:
        try:
            ...
            movies = tmdb.Movies(id=id)
            trailers = movies.videos(id=id)
